          ...
          <div className={styles.deliveryInfo}>
            ...
            <div className={styles.deliveryAddrCard}>
              <div className={styles.deliveryAddrCardTop}>
                ...
                <span className={styles.deliveryAddrCardBadge}>{DELIVERY_ADDRESS.type}</span>
              </div>
              <h2 className={styles.deliveryInfoCompany}>{DELIVERY_ADDRESS.company}</h2>
              <div className={styles.deliveryAddrDivider} />
              <p className={styles.deliveryInfoAddr}>{DELIVERY_ADDRESS.line1}</p>
