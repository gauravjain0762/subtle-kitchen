...
export default function ProfilePage() {
  ...
  const NAV_TABS = [
    { id: "orders",   label: "Orders",   icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="M9 12h6M9 16h4"/></svg> },
    ...
    <div className={styles.root}>
      ...
      <div className={styles.profileBanner}>
        <div className={styles.profileBannerInner}>
          ...
          <button className={styles.editProfileBtn} onClick={() => setEditOpen(true)}>Edit Profile</button>
        </div>
      </div>
